...
<nav class="navbar sticky top-0 z-50">
    ...
    <div class="max-w-7xl mx-auto px-5 md:px-6">
        ...
        <div class="h-[70px] flex items-center justify-between">
            ...
            <a
                href="login.php"
                class="login-btn flex items-center gap-2"
            >
            ...
            <div class="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
                ...
                <div>
                    ...
                    <p class="hero-description mt-6 text-sm md:text-base">
                        ...
                        Platform informasi resmi pertandingan
                        Basketball Production Cup 2026.
                        Pantau jadwal, hasil pertandingan,
                        dan klasemen secara terpusat.
                            ...
                            <?php foreach ($standings as $index => $team): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span
                                            class="heading font-extrabold text-navy"
                                        >
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
                ...
                <p class="footer-muted text-[11px] leading-relaxed mt-4 max-w-md">
                    ...
                    Portal informasi resmi Production Cup Basketball 2026
                    untuk memantau jadwal, hasil pertandingan,
                    dan klasemen turnamen.
